                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nodex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nodex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodex: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zENX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nodex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nodex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nodex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nodex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nodex addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nodex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nodex Core help message to get a list with possible Nodex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nodex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nodex network", "", count));
}
...
{
    QString strTitle = tr("Nodex Core"); // default title
